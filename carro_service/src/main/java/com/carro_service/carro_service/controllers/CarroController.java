package com.carro_service.carro_service.controllers;
...
public class CarroController {
    ...
    public ResponseEntity<Carro> obtenerCarro(@PathVariable("id") int id) {
        Carro carro = carroService.getUsuarioById(id);
        if (carro == null) {
    ...
    public ResponseEntity<List<Carro>> obtenerCarrosByIdUsuario(@PathVariable("usuarioId") int usuarioId) {
